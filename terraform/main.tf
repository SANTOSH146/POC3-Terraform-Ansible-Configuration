...
resource "aws_instance" "docker_instance" {
  ...
  key_name      = var.key_name           # Replace with your AWS key pair
  ...
  command = "ansible-playbook -i ${self.public_ip}, --private-key /home/santosh/terraform_kp.pem -u ubuntu --ssh-extra-args='-o StrictHostKeyChecking=no' /home/santosh/Terraform-POC/Ansible/playbook.yml --extra-vars 'jenkins_url=http://${self.public_ip}:8080'"
}


  # provisioner "local-exec" {
  #   command = "ansible-playbook -i ${self.public_ip}, --private-key /home/santosh/terraform_kp.pem -u ubuntu --ssh-extra-args='-o StrictHostKeyChecking=no' /home/santosh/jenkins_sonarqube_confi/sonarqube.yml 'sonarqube_url=http://${self.public_ip}:9000'"
  # }
